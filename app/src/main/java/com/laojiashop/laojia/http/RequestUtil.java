...
public class RequestUtil {
    ...
    public static <T> void request(BaseListOtherActivity activity, boolean showLoading, boolean showRetry,
    ...
    private static void handleError(Throwable throwable,
                                    BaseListOtherActivity activity,
                                    OnFailureListener onFailureListener,
    ...
    private static void dismissProgressDialog(BaseListOtherActivity activity) {
    ...
    private static void dismissNetworkError(BaseListOtherActivity activity) {
        if (activity == null) return;
        ((ViewGroup) activity.findViewById(R.id.baseContentView))
                .removeView(activity.findViewById(R.id.networkErrorContainer));
    }

    private static void showNetworkError(BaseListOtherActivity activity, String errorMsg, View.OnClickListener retryAction) {
        if (activity == null) return;
    ...
    private static void showProgressDialog(BaseListOtherActivity activity) {
    ...
    private static void setupProgressBar(BaseListOtherActivity activity) {
        View progressBarContainer = activity.findViewById(R.id.progressBarContainer);
        ViewGroup contentView = activity.findViewById(R.id.baseContentView);
