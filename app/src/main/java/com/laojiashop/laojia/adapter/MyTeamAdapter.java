...
public class MyTeamAdapter extends BaseQuickAdapter<HotstyletorecommendBean,BaseViewHolder> {
    public MyTeamAdapter(int layoutResId, @Nullable List<HotstyletorecommendBean> data) {
