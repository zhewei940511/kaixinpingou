...
import com.laojiashop.laojia.utils.Util;
...
public class WechatShareManager {
    ...
    private void initWechatShare(Context context){
        if (mWXApi == null) {
            mWXApi = WXAPIFactory.createWXAPI(context, ComParamContact.APP_ID, true);
        }
        mWXApi.registerApp(ComParamContact.APP_ID);
    }
    ...
    private void shareVideo(ShareContent shareContent, int shareType) {
        ...
        msg.title = shareContent.getTitle();
        msg.description = shareContent.getContent();
        Bitmap thumb = BitmapFactory.decodeResource(mContext.getResources(), R.drawable.icon_test);
