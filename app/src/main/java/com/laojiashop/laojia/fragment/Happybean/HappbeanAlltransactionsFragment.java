 ...
 * 全部交易
 */
public class HappbeanAlltransactionsFragment extends BaseFragment {
    ...
    protected void initData() {
        ...
        HomemallPageFragmentAdapter adapter=new HomemallPageFragmentAdapter(R.layout.item_happbeanalltransactionsfragment,mDataList);
