...
public class AuctionListItemDecoration extends RecyclerView.ItemDecoration {
    private Drawable mDivider;
    private boolean mShowLastLine;
    private int mHorizonSpan;
    private int mVerticalSpan;

    private AuctionListItemDecoration(int horizonSpan, int verticalSpan, int color, boolean showLastLine) {
...
//            //满足条件( 最后一行 && 不绘制 ) 将vertical多出的一部分去掉;
    ...
    public static class Builder {
         ...
         * 是否最后一条显示分割线
         * */
        public AuctionListItemDecoration.Builder setShowLastLine(boolean show){
            mShowLastLine = show;
            return this;
        }

        public AuctionListItemDecoration build() {
            return new AuctionListItemDecoration(mHorizonSpan, mVerticalSpan, mColor,mShowLastLine);
        }
    }
}
