...
import com.laojiashop.laojia.utils.TabFragmentManager;
...
public class VerticalTabLayout extends ScrollView {
    ...
    public VerticalTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mIndicatorWidth = (int) typedArray.getDimension(R.styleable.VerticalTabLayout_indicator_width, Util.dp2px(getResources(),3));
